...
TVM_REGISTER_GLOBAL("tvm_graph._save_param_dict").set_body([](TVMArgs args, TVMRetValue* rv) {
...
TVM_REGISTER_GLOBAL("tvm_graph._create_executor").set_body([](TVMArgs args, TVMRetValue* rv) {
...
TVM_REGISTER_GLOBAL("tvm_graph._get_module_from_graph").set_body([](TVMArgs args, TVMRetValue* rv) {
  void* graph_handle = args[0];
