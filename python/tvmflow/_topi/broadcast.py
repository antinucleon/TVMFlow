...
def _get_bcast_info(original_shape, target_shape):
    ...
    original_shape = [i for i in reversed(original_shape)]
    target_shape = [i for i in reversed(target_shape)]
    back_infer = True
    # default back info
...
def broadcast_to(data, shape):
    ...
    bcast_info = _get_bcast_info(
        original_shape=original_shape, target_shape=shape)
